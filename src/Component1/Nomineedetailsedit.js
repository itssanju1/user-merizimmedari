...
<span>My Account </span>
  ...
  <thead>
    <tr style={{backgroundColor:'rgb(176, 193, 219)',width:'100%'}}>
      <th scope="col" style={{textTransform: "capitalize",fontSize:'18px',color:'rgb(43, 77, 129)',width:'22%',borderRight:'2px solid white',textAlign:'center',lineHeight:"20px"}}>Nominee Name
      </th>
      <th scope="col" style={{textTransform: "capitalize",fontSize:'18px',color:'rgb(43, 77, 129)',width:'18%',borderRight:'2px solid white',textAlign:'center',lineHeight:"20px"}}>Relation with <br></br> Nominee</th>
